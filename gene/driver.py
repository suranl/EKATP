...
#
parser.add_argument('--model', type=str, default='EKATP', metavar='N', help='model')
#
...
#
parser.add_argument('--epochs', type=int, default=601, metavar='N', help='number of epochs to train (default: 10)')
#
parser.add_argument('--batch', type=int, default=6, metavar='N', help='batch size (default: 10000)')
#
parser.add_argument('--batch_test', type=int, default=2, metavar='N', help='batch size  for test set (default: 10000)')
#
...
#
parser.add_argument('--nu', type=float, default='5e-1',  help='tune backward loss')
#
...
#
parser.add_argument('--bottleneck', type=int, default='12',  help='size of bottleneck layer')
#
parser.add_argument('--lr_update', type=int, nargs='+', default=[40, 150, 350, 500], help='decrease learning rate at these epochs')
#
...
#
parser.add_argument('--pred_steps', type=int, default='6',  help='prediction steps')
#
...
# load data
#******************************************************************************
Xtrain, Xtest, m, n,xmin,xptp= data_from_name(args.dataset)
...
print("args.steps_back=",args.steps_back)
print("args.alpha=",args.alpha)
print("args.init_scale=",args.init_scale)


model = embed_koopmanAE(m, n, args.bottleneck, args.steps, args.steps_back, args.alpha, args.init_scale)
print('EKATP')
...
np.save(args.folder +'/Our_pred.npy', error)
