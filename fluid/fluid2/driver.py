...
#
parser.add_argument('--steps', type=int, default='10',  help='steps for learning forward dynamics')
#
parser.add_argument('--steps_back', type=int, default='10',  help='steps for learning backwards dynamics')
#
