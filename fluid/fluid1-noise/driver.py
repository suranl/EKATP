...
#
parser.add_argument('--steps', type=int, default='12',  help='steps for learning forward dynamics')
#
parser.add_argument('--steps_back', type=int, default='12',  help='steps for learning backwards dynamics')
#
parser.add_argument('--bottleneck', type=int, default='8',  help='size of bottleneck layer')
#
...
#
parser.add_argument('--pred_steps', type=int, default='100',  help='prediction steps')
#
...
for i in range(30):
            ...
            for j in range(args.pred_steps):
                ...
                last_pred.append(x_pred.data.cpu().numpy().reshape(m,n).squeeze(1))
                if i == 0:
                    snapshots_pred.append(x_pred.data.cpu().numpy().reshape(m,n))
                    snapshots_truth.append(target_temp)
 
            array_pred = np.array(last_pred)
...
print('max',error.max())
print('min',error.min())
print('avg',np.mean(error.mean(axis=0)))
